...
class GitaddMod(loader.Module):
    ...
    def __init__(self):
        self.config = loader.ModuleConfig("GH_TOKEN", "сюда", lambda m: self.strings("cfg_token", m),
            "GH_USERNAME", "сюда", lambda m: self.strings("cfg_gh_user", m),
            "GH_REPO", "сюда", lambda m: self.strings("cfg_gh_repo", m))
